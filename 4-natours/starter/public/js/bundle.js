...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ3l1cmllbGYiLCJhIjoiY2s5Mms3MXpjMDB6cDNpbXg2d2p0eWR5aSJ9.IumvY_2YkOhOzD23B_FEHg';
  var map = new mapboxgl.Map({
    ...
    dragRotate: false,
    animate: false // center: [19.040236, 47.497913],
    // zoom: 13,
    // interactive: false,
    // antialias: true
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Add the new marker.
...
var showAlert = function showAlert(type, message) {
  ...
  var bdy = document.querySelector('.alert'); // console.log(bdy);
};
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              ...
              requestedURL = reqQueryParams.get('requestedUrl');
...
exports.updateSettings = exports.currentUserPasswordChange = exports.currentUserUpdate = void 0;
...
var currentUserUpdate = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            console.log(_context.t0.result.data.message);
  ...
  return function currentUserUpdate(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
/**
...
var currentUserPasswordChange = /*#__PURE__*/function () {
  ...
  return function currentUserPasswordChange(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
/**
...
exports.currentUserPasswordChange = currentUserPasswordChange;
...
var updateSettings = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " change was successfully!"));
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
          ...
          case 8:
            ...
            console.log(_context3.t0.result.data.message);
  ...
  return function updateSettings(_x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();

exports.updateSettings = updateSettings;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"password.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'We sent the reset link if the email address exist.');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var passwordReset = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            tokeID = pageURL.substr(pageURL.lastIndexOf('/') + 1); // console.log(tokeID);

            _context2.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:8000/api/v1/users/resetPassword/".concat(tokeID),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
          ...
          case 9:
            ...
            _context2.t0 = _context2["catch"](0);
            console.log('Error...');
            (0, _alerts.showAlert)('error', _context2.t0.response.data.message); // console.log(err.result.data.message);
  ...
  return function passwordReset(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(tourId); // 1) get the session from the server

            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'GET',
              url: "http://localhost:8000/api/v1/booking/checkout-session/".concat(tourId)
            });
...
var passwordSaveButton = document.querySelector('.form-user-settings'); // const updateSaveButton = document.getElementById('updateSaveBtn');

var updateSaveButton = document.querySelector('.form-user-data');
var forgotPasswordForm = document.getElementById('forgotPassword__form');
var passwordResetForm = document.getElementById('passwordResetForm');
var bookingButton = document.getElementById('bookNow'); // Delegation
...
if (passwordSaveButton) {
  passwordSaveButton.addEventListener('submit', /*#__PURE__*/function () {
...
if (passwordResetForm) {
  passwordResetForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(el) {
      var newPassword, newPasswordConfirm;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 5;
              return (0, _password.passwordReset)(newPassword, newPasswordConfirm);
