...
var showAlert = function showAlert(type, message) {
  ...
  var bdy = document.querySelector('.alert');
  console.log(bdy);
};
...
var passwordResetForm = document.getElementById('passwordResetForm'); // Delegation
