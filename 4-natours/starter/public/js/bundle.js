...
exports.currentUserPasswordChange = exports.currentUserUpdate = void 0;
...
if (updateSaveButton) {
  updateSaveButton.addEventListener('click', function (e) {
    ...
    e.preventDefault();
    (0, _account.currentUserUpdate)(userName, userEmail);
  });
}

if (passwordSaveButton) {
  passwordSaveButton.addEventListener('click', function (e) {
    var currentPassword = document.getElementById('password-current').value;
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('password-confirm').value;
    e.preventDefault();
    (0, _account.currentUserPasswordChange)(currentPassword, password, passwordConfirm);
  });
}
